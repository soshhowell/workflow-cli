...
- Manual testing with example workflow files
- Installation testing via `pip install -e .`
- Functionality testing with various scenarios (success, failure, retry)
...
# Test comprehensive functionality (recommended primary test)
...
4. **Update Example**: **REQUIRED** - Add examples of new features to `example_workflow.json`
5. **Testing**: Verify functionality works with the updated example workflow
